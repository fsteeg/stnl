...
import meinPaket.GUI_suffixe.MyActionListener;
import meinPaket.GUI_suffixe.Menuleiste.MenuActionListener;

public class GUI_praefixe extends JFrame{
	
	// aktuelles Fenster
	public static GUI_praefixe meinFenster;
	public Tree_praefixe meinSuffixBaum = new Tree_praefixe();
	...
	public GUI_praefixe(String titel){
		super(titel);
	...
	public void erzeugeTree(){
		...
		meinSuffixBaum = new Tree_praefixe();
		if(!tf1){
	...
	class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent event){
			...
			// TEXTDATEI SUCHEN
				...
				FileDialog d = new FileDialog(GUI_praefixe.meinFenster, "Oeffnen...", FileDialog.LOAD);
				d.pack(); 
				d.setVisible(true);
			...
			// GESPEICHERTEN BAUM EINLESEN
				...
				try{
					...
					meinSuffixBaum = (meinPaket.Tree_praefixe)ois.readObject();
