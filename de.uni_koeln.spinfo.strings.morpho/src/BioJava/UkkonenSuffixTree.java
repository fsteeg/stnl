...
/// Klasse: UkkonenSuffixTree.java	
/// Paket: BioJava
/// Autor: Eva Hasler (Änderungen)
/// Quelle: biojava-1.4.tar.gz
/// Datum: 8.4.06						
///////////////////////////////////////

// package org.biojava.bio.symbol; (Änderung: Eva Hasler)
package BioJava;
...
public class UkkonenSuffixTree{
  ...
  // private FiniteAlphabet alpha; (Änderung: Eva Hasler)
  ...
  public UkkonenSuffixTree(){
    ...
    e=0;
    sequences = "";
    // alpha=null; (Änderung: Eva Hasler)
  }

  public UkkonenSuffixTree(String seqs){
    this();
    // addSequence(seqs, "unnamed", false); (Änderung: Eva Hasler)
    addSequence(seqs, false);
  }
   ...
   */
  // public void addSequence(String seq, String name, boolean doNotTerminate){ (Änderung: Eva Hasler)
  	public void addSequence(String seq, boolean doNotTerminate){
    int i;
    int start, end;
  ...
  // protected CharSequence getEdgeLabel(SuffixNode child){ (Änderung: Eva Hasler)
  ...
  // protected ArrayList getAllNodes(SuffixNode root, ArrayList list, boolean leavesOnly){ (Änderung: Eva Hasler)
  public ArrayList getAllNodes(SuffixNode root, ArrayList list, boolean leavesOnly){
    Iterator iterator;
    if (list==null)
      list= new ArrayList();
  ...
  public static abstract class SuffixNode {
    ...
    // SuffixNode parent; (Änderung: Eva Hasler)
    public SuffixNode parent;
    SuffixNode suffixLink;
    int labelStart, labelEnd;
    // HashMap children; (Änderung: Eva Hasler)
