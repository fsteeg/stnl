...
public class GUI_suffixe extends JFrame{
	
	// aktuelles Fenster
	public static GUI_suffixe meinFenster;
	public Tree_suffixe meinSuffixBaum = new Tree_suffixe();
	...
	public GUI_suffixe(String titel){
		super(titel);
	...
	public void erzeugeTree(){
		...
		meinSuffixBaum = new Tree_suffixe();
		if(!tf1){
	...
	class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent event){
			...
			// TEXTDATEI SUCHEN
				...
				FileDialog d = new FileDialog(GUI_suffixe.meinFenster, "Oeffnen...", FileDialog.LOAD);
				d.pack(); 
				d.setVisible(true);
			...
			// GESPEICHERTEN BAUM EINLESEN
				...
				try{
					...
					meinSuffixBaum = (meinPaket.Tree_suffixe)ois.readObject();
