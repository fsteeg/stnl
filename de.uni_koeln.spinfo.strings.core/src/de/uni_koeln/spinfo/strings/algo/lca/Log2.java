...
public class Log2 {
     ...
     * 
     * @param n
     *            the integer to evaluate floor(log base 2) at
    ...
    public static int lg2(int n) {
        ...
        if (n >= table.length) { // double-check works here because table
     ...
     * 
     * @param n
     *            evaluate lowZeros here. Must be > 0
     * @return the number of continguous zeros terminating at the low order bit
     * @exception IllegalArgumentException
     *                if n <= 0
     */
